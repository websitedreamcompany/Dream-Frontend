...
const ProjectsIpad = () => {
  const { projectData, moreData } = useDreamTradingStore((state) => state);
  ...
  return (
    <div className="h-dvh overflow-hidden">
      ...
      <main className="application h-dvh w-full overflow-y-scroll bg-[#D9D9D9] pb-19 ">
        <div className="grid  grid-cols-12 h-[85%]  bg-[#D9D9D9] ">
          <section className="bg-transparent   p-5   overflow-y-auto h-fit col-span-5 ">
          ...
          <section
            className={`${itim.className} bg-tansparent  h-fit    p-5   overflow-y-auto  pb-20 col-span-7`}
          >
            <div
            ...
            >
              <div className=" fh-50 p-3 justify-center ">
                <div className="relative w-5 h-[calc(10*var(--spacing-fw))]  ">
                  <Image
            ...
            <div className="">
              ...
              <div className=" grid grid-cols-2  gap-3  mt-3 overflow-y-scroll fh-330">
                {moreData &&
                  moreData.length > 0 &&
                  moreData.slice(0, 8).map((item, index) => (
                    <div
                      key={index}
        ...
        <motion.section
          ...
          className={`${itim.className} p-5    overflow-hidden fh-400 mt-50 mb-10 col-span-5 `}
        >
          <div className="bg-white w-[95%] h-dvh p-5 flex">
            <div className="w-[80%]">
              <div className="relative w-[90%] h-[calc(70*var(--spacing-fw))]  ">
                <Image
                  src={selectedItemDetails?.img || "/default_image.png"}
                  alt="project_menu"
                  fill
                  sizes="100%"
            ...
            <div className=" w-[70%] ">
              <div className="relative   ">
                <div className=" fh-40   gap-1 flex">
                  <button className="bg-[#C5C4C4] fh-40 w-[80%]   "></button>
                  ...
                  <button className="bg-[#C5C4C4] fh-40  w-[90%] justify-center flex  ">
                    <Image
                      src="/slanted_rect_for_menu.png"
                      alt={`App `}
                      width={35}
              ...
              <div className="mt-5 flex justify-center flex-col gap-3 place-items-center">
                <button className="bg-[#800020] fh-50 w-[90%] rounded text-white">
                  Book project
                </button>

                <div className="flex gap-2 fh-30   w-[90%]  ">
                  <div className="bg-[#2E0B80] w-[60%] fh-40">
                    <div className="flex gap-1 fh-30 justify-center m-1 ">
                      {Array(5)
                        .fill(0)
                        .map((_, index) => (
                          <Image
                  ...
                  <div className=" w-[40%] bg-[#D9D9D9]  fh-40 flex justify-center place-items-center">
                    <p className="text-fw-9">120 previews</p>
                  </div>
                </div>
                ...
                <div className="  mt-3  w-[90%]  grid grid-cols-3 justify-center place-items-center gap-2 ">
                  <div className="bg-[#D9D9D9] w-full p-3 flex justify-center place-items-center gap-2">
                    <p className="fh-10 bg-[#2E0B80] fw-4" />
                    <p>L35</p>
                  </div>
                  ...
                  <div className="bg-[#D9D9D9] w-full p-3 flex justify-center place-items-center gap-2">
                    <p className="fh-10 bg-[#4A4A4A] fw-4" />
                    <p>Save</p>
                  </div>
                </div>
              </div>
